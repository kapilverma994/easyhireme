                                                    ...
                                                    <div id="accordion" class="accordion">
                                                        <div class="card mb-0">
                                                            <div class="card-header collapsed" data-toggle="collapse" href="#collapseOne">
                                                                <a class="card-title">
                                                                    <span>Rupesh</span> <span>Delhi</span> <span>Post 1</span>
                                                                </a>
                                                            </div>
                                                            <div id="collapseOne" class="card-body collapse" data-parent="#accordion" >
                                                                <div className="bookinglist_box2 mt-3 py-2">
                                                                    <div className="pro_view_list">
                                                                        <div className="row">
                                                                            <div className="col-5 col-sm-5 col-md-5">
                                                                                <div className="pvl_dtl">
                                                                                    <label>Name</label>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div className="pro_view_list">
                                                                        <div className="row">
                                                                            ...
                                                                            <div className="col-7 col-sm-7 col-md-7">
                                                                                <div className="pvl_dtl">
                                                                                    : Rajdhani Park Mundka New Delhi
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                                                <a class="card-title">
                                                                <span>Cp Singh</span> <span>Delhi</span> <span>Service 2</span>
                                                                </a>
                                                            </div>
                                                            ...
                                                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                                                                <a class="card-title">
                                                                <span>Komal Kumari</span><span>Delhi</span> <span>Service 3</span>
                                                                </a>
                                                            </div>
                ...
                <div className="modal-dialog">
                    <div className="modal-content mdlcntnt">
                        ...
                        <div className="modal-header scrch py-1">
                            <h4 className="modal-title">Machinery Service Detail</h4>
