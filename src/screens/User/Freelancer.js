                    ...
                    <div className='user-right-box'>
                        <div className='container'>
                            <div className='manage_profile'>
                                <h4 className='border-bottom pb-2 mt-3'>Hire Freelancer</h4>
                                                    ...
                                                    <div id="accordion" class="accordion">
                                                        <div class="card mb-0">
                                                            <div class="card-header collapsed" data-toggle="collapse" href="#collapseOne">
                                                                <a class="card-title">
                                                                    <span>Cp Singh</span> <span>Delhi</span> <span>Post 1</span>
                                                                </a>
                                                            </div>
                                                                    ...
                                                                    <div className="row">
                                                                        <div className="col-4 col-sm-4 col-md-4 pr-1">
                                                                            <div className="order_id">
                                                                                <div className=""><strong>Post Id</strong></div>
                                                                        ...
                                                                        <div className="col-4 col-sm-4 col-md-4 pr-1">
                                                                            <div className="order_name">
                                                                                <div className=""><strong>Post Type</strong></div>
                                                                                <div className="ph">Designer</div>
                                                                            </div>
                                                                            <div className="order_name">
                                                                                <div className=""><strong>Post Name</strong></div>
                                                                                <div className="ph">Web Designer</div>
                                                                            </div>
                                                                            <div className="order_name">
                                                                                <div className=""><strong>Post Date</strong></div>
                                                                        ...
                                                                        <div className="col-4 col-sm-4 col-md-4 pl-1 text-right view_btn">
                                                                            ...
                                                                            <div className="mt-2">
                                                                                <button type="button" className="btn btn-success btn-sm">Post Done</button>
                                                                        ...
                                                                        <div className="row">
                                                                            ...
                                                                            <div className="col-8 col-sm-8 col-md-8 pl-0 text-right">
                                                                                <div className="track_id1">
                                                                                    ...
                                                                                    <div className="">
                                                                                        <button type="button" className="accetp_btn">Accept Post</button>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                ...
                <div className="modal-dialog">
                    <div className="modal-content mdlcntnt">
                        ...
                        <div className="modal-header scrch py-1">
                            <h4 className="modal-title">Freelancer Details</h4>
                            ...
                            <div className="orderbx">
                                ...
                                <div className="oder_box">
                                    <div className="row">
                                        <div className="col-4 col-sm-4">
                                            <div className="">
                                                <button type="button" className="btn btn-primary">Visit Post</button>
                                            </div>
                                        </div>
                                ...
                                <div className="oder_box mt-3">
                                    <div className="row">
                                        <div className="col-5 col-sm-5">
                                            <div className="">
                                                <button type="button" className="btn btn-success">Post Done</button>
                                            </div>
                                        </div>
                                        <div className="col-7 col-sm-7">
