                    ...
                    <div className='user-right-box'>
                        <div className='container'>
                            <div className='manage_profile'>
                                <h4 className='border-bottom pb-2 mt-3'>Hire Job Seeker</h4>
                                                ...
                                                <div className="bookinglist_box text-center p-3">
                                                    <div className="row">
                                                        <div className="col-4 col-sm-4 col-md-4">
                                                            <Link to="#">
                                                                <div className="mb-0">Open Job</div>
                                                            </Link>
                                                        </div>
                                                        <div className="col-4 col-sm-4 col-md-4">
                                                            <Link to="#">
                                                                <div className="mb-0">Apply Condidates</div>
                                                            </Link>
                                                        </div>
                                                        <div className="col-4 col-sm-4 col-md-4">
                                                            <Link to="#">
                                                                <div className="mb-0">Job Close</div>
                                                            </Link>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div id="accordion" class="accordion">
                                                        <div class="card mb-0">
                                                            <div class="card-header collapsed" data-toggle="collapse" href="#collapseOne">
                                                                <a class="card-title">
                                                                    <span>Cp Singh</span> <span>Delhi</span> <span>Job 1</span>
                                                                </a>
                                                            </div>
                                                                    ...
                                                                    <div className="row">
                                                                        <div className="col-4 col-sm-4 col-md-4 pr-1">
                                                                            <div className="order_id">
                                                                                <div className=""><strong>Job Id</strong></div>
                                                                        ...
                                                                        <div className="col-4 col-sm-4 col-md-4 pr-1">
                                                                            <div className="order_name">
                                                                                <div className=""><strong>Job Type</strong></div>
                                                                                <div className="ph">Designer</div>
                                                                            </div>
                                                                            <div className="order_name">
                                                                                <div className=""><strong>Job Name</strong></div>
                                                                                <div className="ph">Web Designer</div>
                                                                            </div>
                                                                            <div className="order_name">
                                                                                <div className=""><strong>Job Date</strong></div>
                                                                        ...
                                                                        <div className="col-4 col-sm-4 col-md-4 pl-1 text-right view_btn">
                                                                            <div className="">
                                                                                <button onClick={()=>setOrderid(true)} type="button" className="btn btn-danger btn-sm">View Deail</button>
                                                                            </div>
                                                                            <div className="mt-2">
                                                                                <button type="button" className="btn btn-primary btn-sm">Visit Job</button>
                                                                                <div className="">30/11/2021 11:40 A.M</div>
                                                                            </div>
                                                                            <div className="mt-2">
                                                                                <button type="button" className="btn btn-success btn-sm">Job Done</button>
                                                                        ...
                                                                        <div className="row">
                                                                            ...
                                                                            <div className="col-8 col-sm-8 col-md-8 pl-0 text-right">
                                                                                <div className="track_id1">
                                                                                    ...
                                                                                    <div className="">
                                                                                        <button type="button" className="accetp_btn">Accept Job</button>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                                                <a class="card-title">
                                                                <span>Rohit</span> <span>Delhi</span> <span>Post 2</span>
                                                                </a>
                                                            </div>
                                                                ...
                                                                <div className="bookinglist_box2 mt-3 py-2">
                                                                    <div className="row">
                                                                        <div className="col-4 col-sm-4 col-md-4 pr-1">
                                                                            ...
                                                                            <div className="order_name">
                                                                                <div className=""><strong>Rohit</strong></div>
                                                                                <div className="ph"><i class="fa fa-phone-square"></i> 56873147</div>
                                                                            </div>
                                                                            <div className="order_name">
                                                                                <div className="email"><strong>rohit@gmail.com</strong></div>
                                                                                <div className=""><strong>Payment</strong></div>
                                                                                <div className="cod">
                                                                                    COD(AED) : 42.18
                                                                                </div>
                                                                        ...
                                                                        <div className="col-4 col-sm-4 col-md-4 pl-1 text-right view_btn">
                                                                            <div className="">
                                                                                <button onClick={()=>setOrderid(true)} type="button" className="btn btn-danger btn-sm">View Detail</button>
                                                                            </div>
                                                                            <div className="mt-2">
                                                                                <button type="button" className="btn btn-primary btn-sm">Visit Job</button>
                                                                                <div className="">30/11/2021 11:40 A.M</div>
                                                            ...
                                                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                                                                <a class="card-title">
                                                                <span>Sumit Kumar</span><span>Delhi</span> <span>Post 3</span>
                                                                </a>
                                                            </div>
                                                                    ...
                                                                    <div className="bookinglist_box2 mt-3 py-2">
                                                                        <div className="row">
                                                                            <div className="col-4 col-sm-4 col-md-4 pr-1">
                                                                                ...
                                                                                <div className="order_name">
                                                                                    <div className=""><strong>Sumit Kumar</strong></div>
                                                                                    <div className="ph"><i class="fa fa-phone-square"></i> 56873147</div>
                                                                                </div>
                                                                                <div className="order_name">
                                                                                    <div className="email"><strong>sumit@gmail.com</strong></div>
                                                                                    <div className=""><strong>Payment</strong></div>
                                                                                    <div className="cod">
                                                                                        COD(AED) : 42.18
                                                                                    </div>
                                                                            ...
                                                                            <div className="col-4 col-sm-4 col-md-4 pl-1 text-right view_btn">
                                                                                <div className="">
                                                                                    <button onClick={()=>setOrderid(true)} type="button" className="btn btn-danger btn-sm">View Detal</button>
                                                                                </div>
                                                                                <div className="mt-2">
                                                                                    <button type="button" className="btn btn-primary btn-sm">Visit Post</button>
                                                                                    <div className="">30/11/2021 11:40 A.M</div>
                                                                                </div>
                                                                                <div className="mt-2">
                                                                                    <button type="button" className="btn btn-success btn-sm">Job Done</button>
                ...
                <div className="modal-dialog">
                    <div className="modal-content mdlcntnt">
                        ...
                        <div className="modal-header scrch py-1">
                            <h4 className="modal-title">Job Seeker Details</h4>
                            ...
                            <div className="orderbx">
                                ...
                                <div className="oder_box">
                                    <div className="row">
                                        ...
                                        <div className="col-9 col-sm-3">
                                            <div className="">cpsingh@gmail.com</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="oder_box">
                                ...
                                <div className="oder_box">
                                    <div className="row">
                                        ...
                                        <div className="col-7 col-sm-7">
                                            <div className="">110001</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="oder_box">
                                    <label>Address :</label>
                                    <div className="mb-3">Rajdhani Park Mundka New Delhi</div>
                                </div>
                                <div className="oder_box">
                                    <div className="row">
                                        <div className="col-4 col-sm-4">
                                            <div className="">
                                                <button type="button" className="btn btn-primary">Visit Job</button>
                                            </div>
                                        </div>
                                ...
                                <div className="oder_box mt-3">
                                    <div className="row">
                                        <div className="col-5 col-sm-5">
                                            <div className="">
                                                <button type="button" className="btn btn-success">Job Done</button>
                                            </div>
                                        </div>
                                        <div className="col-7 col-sm-7">
