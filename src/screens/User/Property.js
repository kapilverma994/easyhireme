                    ...
                    <div className='user-right-box'>
                        <div className='container'>
                            <div className='manage_profile'>
                                <h4 className='border-bottom pb-2 mt-3'>Property</h4>
                                                    ...
                                                    <div id="accordion" class="accordion">
                                                        <div class="card mb-0">
                                                            <div class="card-header collapsed" data-toggle="collapse" href="#collapseOne">
                                                                <a class="card-title">
                                                                    <span>Mohit Sharma</span> <span>Delhi</span>Property 1 <span></span>
                                                                </a>
                                                            </div>
                                                            <div id="collapseOne" class="card-body collapse" data-parent="#accordion" >
                                                                <div className="bookinglist_box2 my-3 py-2">
                                                                    <div className="row">
                                                                        <div className="col-4 col-sm-4 col-md-4 pr-1">
                                                                            ...
                                                                            <div className="order_name">
                                                                                <div className=""><strong>Diamond Property</strong></div>
                                                                                <div className="ph"><i class="fa fa-phone-square"></i> 56873147</div>
                                                                            </div>
                                                                            <div className="order_name">
                                                                                <div className="email"><strong>diamond@gmail.com</strong></div>
                                                                                <div className="cod">
                                                                                    COD(AED) : 42.18
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div className="col-4 col-sm-4 col-md-4 pl-1 text-right view_btn">
                                                                            ...
                                                                            <div className="mt-2">
                                                                                <button type="button" className="btn btn-primary btn-sm" disabled>Room Allotment</button>
                                                                            </div>
                                                                            <div className="mt-2">
                                                                                <button type="button" className="btn btn-success btn-sm" disabled>Check out Date</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div className="row">
                                                                            ...
                                                                            <div className="col-8 col-sm-8 col-md-8 pl-0 text-right">
                                                                                <div className="track_id1">
                                                                                    ...
                                                                                    <div className="">
                                                                                        <button type="button" className="accetp_btn" disabled>Accepted</button>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                                                <a class="card-title">
                                                                <span>Sunil Kumar</span> <span>Delhi</span> Property 2<span></span>
                                                                </a>
                                                            </div>
                                                                ...
                                                                <div className="bookinglist_box2 my-3 py-2">
                                                                    <div className="row">
                                                                        <div className="col-4 col-sm-4 col-md-4 pr-1">
                                                                            ...
                                                                            <div className="order_name">
                                                                                <div className=""><strong>Divya Property</strong></div>
                                                                                <div className="ph"><i class="fa fa-phone-square"></i> 56873147</div>
                                                                            </div>
                                                                            <div className="order_name">
                                                                                <div className="email"><strong>divya@gmail.com</strong></div>
                                                                                <div className="cod">
                                                                                    COD(AED) : 42.18
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                                                                <a class="card-title">
                                                                <span>Sandeep Kumar</span><span>Delhi</span> Property 3<span></span>
                                                                </a>
                                                            </div>
                                                                    ...
                                                                    <div className="bookinglist_box2 my-3 py-2">
                                                                        <div className="row">
                                                                            <div className="col-4 col-sm-4 col-md-4 pr-1">
                                                                                ...
                                                                                <div className="order_name">
                                                                                    <div className=""><strong>Vinayak Property</strong></div>
                                                                                    <div className="ph"><i class="fa fa-phone-square"></i> 56873147</div>
                                                                                </div>
                                                                                <div className="order_name">
                                                                                    <div className="email"><strong>vinayak@gmail.com</strong></div>
                                                                                    <div className="cod">
                                                                                        COD(AED) : 42.18
                                                                                    </div>
                                                                                </div>
