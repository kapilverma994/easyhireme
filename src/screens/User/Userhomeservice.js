...
function Userhomeservice(props) {
                    ...
                    <div className='user-right-box'>
                        <div className='container'>
                            <div className='manage_profile'>
                                <h4 className='border-bottom pb-2 mt-3'>Home Service</h4>
                                                                    ...
                                                                    <div className="row">
                                                                        ...
                                                                        <div className="col-4 col-sm-4 col-md-4 pr-1">
                                                                            ...
                                                                            <div className="order_name">
                                                                                ...
                                                                                <div className="ph">Corrective Room Cleaning</div>
                                                                            </div>
                                                                            <div className="order_name">
                ...
                <div className="modal-dialog">
                    <div className="modal-content mdlcntnt">
                        ...
                        <div className="modal-header scrch py-1">
                            <h4 className="modal-title">Home Service Detail</h4>
